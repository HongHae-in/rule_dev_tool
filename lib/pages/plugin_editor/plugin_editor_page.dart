              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'SearchURL',
                    border: OutlineInputBorder(),
                    helperText: '搜索URL，使用@keyword作为搜索关键词占位符',
                  ),
                ),
                const SizedBox(height: 20),
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    border: OutlineInputBorder(),
                    helperText: '搜索结果列表的XPath，用于定位搜索结果容器',
                  ),
                ),
                const SizedBox(height: 20),
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    border: OutlineInputBorder(),
                    helperText: '搜索结果名称的XPath，用于提取作品标题',
                  ),
                ),
                const SizedBox(height: 20),
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    border: OutlineInputBorder(),
                    helperText: '搜索结果链接的XPath，用于提取作品详情页URL',
                  ),
                ),
                const SizedBox(height: 20),
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    border: OutlineInputBorder(),
                    helperText: '剧集列表的XPath，用于定位播放列表容器',
                  ),
                ),
                const SizedBox(height: 20),
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    border: OutlineInputBorder(),
                    helperText: '剧集链接的XPath，用于提取每集的播放URL',
                  ),
                ),
                const SizedBox(height: 20),
                ExpansionTile(
